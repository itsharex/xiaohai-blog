  ...
  <div class="app-container">
    <el-card class="box-card box-card-height">
      ...
      >
        ...
        <el-table-column v-if="$store.getters.permission.includes('system:role:update')||$store.getters.permission.includes('system:role:delete')" label="操作" align="center" class-name="small-padding fixed-width" fixed="right" min-width="100">
          <template slot-scope="scope">
            <el-button
              v-if="$store.getters.permission.includes('system:role:update')"
              size="mini"
