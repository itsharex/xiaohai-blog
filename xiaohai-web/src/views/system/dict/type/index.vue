  ...
  <div class="app-container">
    <el-card class="box-card box-card-height">
      ...
      <el-table v-loading="loading" class="table-margin-top-height" :data="typeList" @selection-change="handleSelectionChange">
        ...
        <el-table-column v-if="$store.getters.permission.includes('system:dict:update')||$store.getters.permission.includes('system:dict:delete')" label="操作" align="center" class-name="small-padding fixed-width" width="140">
          <template slot-scope="scope">
            <el-button
              v-if="$store.getters.permission.includes('system:dict:update')"
              size="mini"
